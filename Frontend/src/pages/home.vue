  ...
  <div class="flex h-screen relative bg-white">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex flex-wrap -mx-6">
          ...
          <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
            ...
            >
              ...
              <div class="mx-5">
                <h4 class="text-2xl font-semibold text-gray-700">{{order_count}}</h4>
      ...
      <div class="grid grid-cols-4 gap-4">
        <div>
          <textarea v-model="license" placeholder="License"
                    class="block text-sm py-3 px-4 rounded-lg w-full border outline-none"/>
          <div class="grid place-items-center h-scree">
            <input type="text" v-model="hardware_key" placeholder="Hardware Key"
                   class="block text-sm py-3 px-4 rounded-lg w-full border outline-none"/>
            ...
            <button @click="generate" type="button"
                    class="whitespace-nowrap inline-flex items-center justify-center p-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-green-700 hover:bg-green-600"
                    aria-expanded="false" :disabled="button_status">Generate
            </button>
